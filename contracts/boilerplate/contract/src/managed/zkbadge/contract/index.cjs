...
class _Certificate_0 {
  alignment() {
    return _descriptor_2.alignment().concat(_descriptor_4.alignment().concat(_descriptor_4.alignment().concat(_descriptor_3.alignment().concat(_descriptor_2.alignment()))));
  }
  fromValue(value_0) {
    return {
      issuer: _descriptor_2.fromValue(value_0),
      issued_at: _descriptor_4.fromValue(value_0),
      valid_until: _descriptor_4.fromValue(value_0),
      is_valid: _descriptor_3.fromValue(value_0),
      owner: _descriptor_2.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_2.toValue(value_0.issuer).concat(_descriptor_4.toValue(value_0.issued_at).concat(_descriptor_4.toValue(value_0.valid_until).concat(_descriptor_3.toValue(value_0.is_valid).concat(_descriptor_2.toValue(value_0.owner)))));
  }
}
...
class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      verify_certificates: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined))
          __compactRuntime.type_error('verify_certificates',
                                      ...
                                      'zkbadge.compact line 33 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        ...
        const partialProofData = {
          input: {
            value: _descriptor_7.toValue(hashes_0),
      ...
      register: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined))
          __compactRuntime.type_error('register',
                                      'argument 1 (as invoked from Typescript)',
                                      'zkbadge.compact line 44 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        const context = { ...contextOrig_0 };
        const partialProofData = {
      ...
      check_verification: (...args_1) => {
        if (args_1.length !== 1)
          throw new __compactRuntime.CompactError(`check_verification: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined))
          __compactRuntime.type_error('check_verification',
                                      'argument 1 (as invoked from Typescript)',
                                      'zkbadge.compact line 56 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        const context = { ...contextOrig_0 };
        const partialProofData = {
        ...
        const result_0 = this.#_check_verification_0(context, partialProofData);
        partialProofData.output = { value: _descriptor_3.toValue(result_0), alignment: _descriptor_3.alignment() };
        return { result: result_0, context: context, proofData: partialProofData };
      },
      access_private_feature: (...args_1) => {
        if (args_1.length !== 1)
          throw new __compactRuntime.CompactError(`access_private_feature: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined))
          __compactRuntime.type_error('access_private_feature',
                                      'argument 1 (as invoked from Typescript)',
                                      'zkbadge.compact line 63 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        const context = { ...contextOrig_0 };
        const partialProofData = {
      ...
      cert_hash: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined))
          __compactRuntime.type_error('cert_hash',
                                      'argument 1 (as invoked from Typescript)',
                                      'zkbadge.compact line 71 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        if (!(typeof(cert_0) === 'object' && typeof(cert_0.issuer) === 'object' && cert_0.issuer.bytes.buffer instanceof ArrayBuffer && cert_0.issuer.bytes.BYTES_PER_ELEMENT === 1 && cert_0.issuer.bytes.length === 32 && typeof(cert_0.issued_at) === 'bigint' && cert_0.issued_at >= 0 && cert_0.issued_at <= 18446744073709551615n && typeof(cert_0.valid_until) === 'bigint' && cert_0.valid_until >= 0 && cert_0.valid_until <= 18446744073709551615n && typeof(cert_0.is_valid) === 'boolean' && typeof(cert_0.owner) === 'object' && cert_0.owner.bytes.buffer instanceof ArrayBuffer && cert_0.owner.bytes.BYTES_PER_ELEMENT === 1 && cert_0.owner.bytes.length === 32))
          __compactRuntime.type_error('cert_hash',
                                      'argument 1 (argument 2 as invoked from Typescript)',
                                      'zkbadge.compact line 71 char 1',
                                      'struct Certificate<issuer: struct ZswapCoinPublicKey<bytes: Bytes<32>>, issued_at: Uint<0..18446744073709551615>, valid_until: Uint<0..18446744073709551615>, is_valid: Boolean, owner: struct ZswapCoinPublicKey<bytes: Bytes<32>>>',
                                      cert_0)
        const context = { ...contextOrig_0 };
        const partialProofData = {
          input: {
            value: _descriptor_5.toValue(cert_0),
  ...
  #_user_certificate_0(context, partialProofData) {
    ...
    if (!(typeof(result_0) === 'object' && typeof(result_0.issuer) === 'object' && result_0.issuer.bytes.buffer instanceof ArrayBuffer && result_0.issuer.bytes.BYTES_PER_ELEMENT === 1 && result_0.issuer.bytes.length === 32 && typeof(result_0.issued_at) === 'bigint' && result_0.issued_at >= 0 && result_0.issued_at <= 18446744073709551615n && typeof(result_0.valid_until) === 'bigint' && result_0.valid_until >= 0 && result_0.valid_until <= 18446744073709551615n && typeof(result_0.is_valid) === 'boolean' && typeof(result_0.owner) === 'object' && result_0.owner.bytes.buffer instanceof ArrayBuffer && result_0.owner.bytes.BYTES_PER_ELEMENT === 1 && result_0.owner.bytes.length === 32))
      __compactRuntime.type_error('user_certificate',
                                  'return value',
                                  'zkbadge.compact line 20 char 1',
                                  'struct Certificate<issuer: struct ZswapCoinPublicKey<bytes: Bytes<32>>, issued_at: Uint<0..18446744073709551615>, valid_until: Uint<0..18446744073709551615>, is_valid: Boolean, owner: struct ZswapCoinPublicKey<bytes: Bytes<32>>>',
                                  result_0)
    partialProofData.privateTranscriptOutputs.push({
  ...
  #_register_0(context, partialProofData) {
    const cert_0 = this.#_user_certificate_0(context, partialProofData);
    __compactRuntime.assert(cert_0.is_valid === true, 'Certificate not valid');
    __compactRuntime.assert(this.#_equal_1(cert_0.owner,
                                           this.#_ownPublicKey_0(context,
                                                                 partialProofData)),
  ...
  #_check_verification_0(context, partialProofData) {
    const cert_0 = this.#_user_certificate_0(context, partialProofData);
    const hash_0 = this.#_cert_hash_0(context, partialProofData, cert_0);
  ...
  #_access_private_feature_0(context, partialProofData) {
    const cert_0 = this.#_user_certificate_0(context, partialProofData);
    const hash_0 = this.#_cert_hash_0(context, partialProofData, cert_0);
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32))
          __compactRuntime.type_error('member',
                                      'argument 1',
                                      'zkbadge.compact line 23 char 1',
                                      'Bytes<32>',
                                      key_0)
        return _descriptor_3.fromValue(Contract._query(context,
                                                       partialProofData,
    ...
    verified_users: {
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'object' && key_0.bytes.buffer instanceof ArrayBuffer && key_0.bytes.BYTES_PER_ELEMENT === 1 && key_0.bytes.length === 32))
          __compactRuntime.type_error('member',
                                      'argument 1',
                                      'zkbadge.compact line 25 char 1',
